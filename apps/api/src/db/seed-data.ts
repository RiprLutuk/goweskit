...
export const DEMO_PLACE_SEEDS = [
  {
    ...
    coordinate: { longitude: 106.618, latitude: -6.18 },
    address: 'Jl. Merdeka No. 45, Karawaci, Tangerang · demo data',
  ...
  },
  {
    ...
    type: 'store',
    name: 'Demo Bike Store Cimone',
    description:
      'Practice listing for parts, helmets, lights, tubes, and basic cycling supplies.',
    coordinate: { longitude: 106.622, latitude: -6.1805 },
    address: 'Jl. Merdeka Simpang Cimone, Tangerang · demo data',
  ...
  },
  {
    ...
    type: 'water',
    name: 'Demo Refill Point Imam Bonjol',
    description:
      'Practice public-water marker near a popular morning-ride gathering area.',
    coordinate: { longitude: 106.6285, latitude: -6.1815 },
    address: 'Simpang Jl. Imam Bonjol, Tangerang · demo data',
    bicycleTypes: ['mtb_hardtail', 'road', 'gravel', 'folding'],
    beginnerFriendly: true,
    verificationStatus: 'community_verified',
  ...
  },
  {
    ...
    type: 'coffee',
    name: 'Demo Coffee Stop Pasar Lama',
    description:
      'Practice coffee-stop marker with bicycle parking and a gentle regroup point.',
    coordinate: { longitude: 106.6322, latitude: -6.183 },
    address: 'Jl. Kisamaun, Pasar Lama, Tangerang · demo data',
    bicycleTypes: ['road', 'gravel', 'folding'],
    beginnerFriendly: true,
  ...
  },
  {
    ...
    coordinate: { longitude: 106.6345, latitude: -6.142 },
    address: 'Pintu Air 10 Cisadane, Tangerang · demo data',
  ...
  },
  {
    ...
    coordinate: { longitude: 106.6315, latitude: -6.1775 },
    address: 'Pasar Lama Tangerang, Jl. Kisamaun · demo data',
    bicycleTypes: ['road', 'gravel', 'folding'],
    beginnerFriendly: true,
    verificationStatus: 'staff_verified',
  ...
  },
  {
    ...
    type: 'rest',
    name: 'Demo Rest Stop Taman Berendeng',
    description:
      'Practice rest marker along a longer flat loop. Carry water and verify opening conditions yourself.',
    coordinate: { longitude: 106.63, latitude: -6.1725 },
    address: 'Taman Berendeng Cisadane, Tangerang · demo data',
...
export const DEMO_ROUTE_SEEDS = [
  ...
  },
  {
    ...
    description:
      'Practice mixed-surface route along the Cisadane riverbank with planned regroup points.',
    coordinates: [
      [106.63, -6.1725],
      [106.6304, -6.168],
      [106.6308, -6.163],
  ...
  },
  {
    ...
    description:
      'Practice short city loop linking Tangerang heritage streets and coffee-stop areas.',
    coordinates: [
      [106.6315, -6.1775],
      [106.6318, -6.18],
      [106.6322, -6.183],
  ...
  },
  {
    id: '30000000-0000-4000-8000-000000000004',
    routeType: 'mtb',
    name: 'Demo Cipondoh Lake Practice',
    description:
      'Practice route along Cipondoh lake shoreline and KH Hasyim Ashari corridor.',
    coordinates: [
      [106.662, -6.193],
      [106.666, -6.196],
      [106.67, -6.199],
