    ...
    <div v-if="loading" style="display: grid; gap: 1rem">
      ...
      >
        ...
        <div style="flex: 1; display: grid; gap: 0.5rem">
          <div
            class="skeleton-shimmer"
            style="width: 30%; height: 1rem; border-radius: 0.35rem"
          />
          <div
            class="skeleton-shimmer"
            style="width: 55%; height: 1.8rem; border-radius: 0.5rem"
          />
          <div
            class="skeleton-shimmer"
            style="width: 80%; height: 0.9rem; border-radius: 0.35rem"
          />
        </div>
      </div>
      <div
        class="skeleton-shimmer"
        style="width: 100%; height: 10rem; border-radius: 1.15rem"
      />
    </div>
